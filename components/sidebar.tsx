  ...
  return (
    <>
      <div className="fixed inset-x-0 top-0 z-40 flex h-14 items-center gap-3 border-b border-[#f5e2dc] bg-[#fff8f4]/95 px-4 backdrop-blur-sm lg:hidden">
        ...
        <span className="whitespace-nowrap font-display text-lg font-semibold text-[#2d2424]">다빈이의 강사일기</span>
        <BetaBadge />
      </div>
      ...
      <div className="flex items-center gap-3 border-b border-[#f5e2dc] px-5 py-5">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-1.5">
            <div className="whitespace-nowrap font-display text-lg font-semibold text-[#2d2424]">
              다빈이의 강사일기
            </div>
            <BetaBadge />
          </div>
